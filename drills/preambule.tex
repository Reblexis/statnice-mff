...
% jádro na 2 body: krystalizace minimální jisté odpovědi (cílí na P(skore<=1))
\newtcolorbox{jadro}{enhanced, breakable, colback=resgreen!10, colframe=resgreen!80!black,
  boxrule=0.6pt, arc=1.5pt, left=7pt, right=7pt, top=2pt, bottom=3pt,
  before skip=4pt, after skip=4pt, fonttitle=\bfseries\footnotesize, coltitle=resgreen!70!black,
  title={Jádro na 2 body \textnormal{\footnotesize(tohle umět nazpaměť = jistá $\ge2$)}}}
...
% hlavička otázky v nanečisto-zkoušce (bez čítače úloh)
\newcommand{\mockq}[3]{\par\smallskip\noindent
  {\bfseries\color{ulohagray}#1}\quad{\small\colorbox{ulohagray!12}{\textbf{#2}}}\quad{\bfseries #3}\par\vspace{1pt}}
