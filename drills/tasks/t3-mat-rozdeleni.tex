...
\begin{enumerate}[label=(\alph*)]
  ...
  \item \bod{2} Zformulujte Markovovu a Čebyševovu nerovnost a jednu použijte.
...
\textbf{(b)} \emph{Markovova}: pro $X\ge0$ a $a>0$ je $P(X\ge a)\le\frac{\mathbb{E}X}{a}$. \emph{Čebyševova}: $P(|X-\mathbb{E}X|\ge k)\le\frac{\operatorname{var}X}{k^2}$. Příklad: má-li $X\ge0$ střední hodnotu $2$, pak $P(X\ge10)\le 2/10=0{,}2$.
...
\begin{jadro}
$\mathrm{Bi}(n,p)$: $\mathbb{E}=np$; geom.: $1/p$; $\mathrm{Po}(\lambda)$: $\lambda$; $\mathcal{N}(\mu,\sigma^2)$: $\mu$; $\mathrm{Exp}(\lambda)$: $1/\lambda$. Markov $P(X\ge a)\le\mathbb{E}X/a$; Čebyšev $P(|X-\mu|\ge k)\le\sigma^2/k^2$. ZVČ: prumer $\to$ střední hodnota.
\end{jadro}
