...
\begin{reseni}
\textbf{(a)} Problém $B$ je NP-úplný, pokud (1) $B\in\mathrm{NP}$ (existuje polynomiálně ověřitelný certifikát) a (2) $B$ je NP-těžký, tj.\ nějaký známý NP-úplný problém se na něj \emph{polynomiálně redukuje}. \emph{Polynomiální redukce} $A\le_p B$ je v polynomiálním čase vyčíslitelná funkce převádějící instance $A$ na instance $B$ se zachováním odpovědi ano/ne.
