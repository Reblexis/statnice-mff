...
\textbf{(c)} \emph{Skalární součin} $\langle x,y\rangle=\sum_i x_iy_i$ (standardní), \emph{norma} $\lVert x\rVert=\sqrt{\langle x,x\rangle}$, vektory jsou \emph{kolmé}, je-li $\langle x,y\rangle=0$. Gram-Schmidt:
\[
