...
\begin{jadro}
k-means minimalizuje $J=\sum_i\lVert x_i-\mu_{c(i)}\rVert^2$ střídáním: (1) přiřaď bod k nejbližšímu centru, (2) přepočti centra na průměr. Konverguje jen do lokálního minima (víc restartu, k-means++), škáluj data. Hierarchické = spojuj nejbližší shluky, dendrogram.
\end{jadro}
