...
\begin{jadro}
Entropie $H(S)=-\sum_k p_k\log_2 p_k$, informační zisk $\mathrm{IG}=H(S)-\sum_j\frac{|S_j|}{|S|}H(S_j)$ (vážený), Gini $1-\sum p_k^2$. Greedy konstrukce podle max IG, prořezávání proti přeučení.
\end{jadro}
