...
\textbf{(c)} \emph{Mengerova věta (hranová):} minimální počet hran, jejichž odebrání rozpojí vrcholy $u,v$, se rovná maximálnímu počtu \emph{hranově disjunktních} cest mezi $u,v$. \emph{Vrcholová verze} (pro různé \emph{nesousední} vrcholy $u,v$): minimální počet vrcholu (různých od $u,v$), jejichž odebrání rozpojí $u,v$, se rovná maximálnímu počtu \emph{vnitřně vrcholově disjunktních} cest mezi $u,v$.
\end{reseni}
