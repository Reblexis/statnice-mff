...
\begin{jadro}
A* rozšiřuje uzel s nejmenším $f(n)=g(n)+h(n)$. Přípustná: $h\le h^*$ (nepřeceňuje). Konzistentní: $h(n)\le c(n,n')+h(n')$. Optimální s přípustnou (stromově) / konzistentní (grafově) heuristikou.
\end{jadro}
