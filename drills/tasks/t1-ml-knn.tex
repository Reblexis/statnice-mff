...
\begin{enumerate}[label=(\alph*)]
  ...
  \item \bod{2} Jak se volí $k$ (křížová validace) a jak malé vs velké $k$ ovlivní výsledek (citlivost na šum vs hladkost hranice)? Proč je nutné škálovat příznaky?
...
\textbf{(b)} $k$ se volí \emph{křížovou validací}. \emph{Malé} $k$ (např.\ 1) je citlivé na šum (nestabilní, přeučení); \emph{velké} $k$ rozhodovací hranici vyhladí (může podučit). \emph{Škálování} je nutné, protože vzdálenost jinak ovládne příznak s největším rozsahem.
