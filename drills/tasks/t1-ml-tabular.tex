...
\begin{jadro}
Předzpracování: one-hot kategorie, škáluj spojité, imputuj chybějící. $\mathrm{MAE}=\frac1n\sum|y-\hat y|$ (robustní), $\mathrm{RMSE}=\sqrt{\frac1n\sum(y-\hat y)^2}$ (trestá velké chyby). Stromy/boosting bývají nejlepší a nepotřebují škálování.
\end{jadro}
