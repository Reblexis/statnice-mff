...
\begin{enumerate}[label=(\alph*)]
  \item \bod{1} Definujte POMDP a pojem belief (víra o stavu).
  \item \bod{2} Napište vzorec aktualizace beliefu po akci $a$ a pozorování $o$.
  \item \bod{3} Spočtěte nový belief po provedení $a$ a pozorování $o$.
\end{enumerate}
\end{zadani}
