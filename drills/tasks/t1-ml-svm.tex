...
\begin{jadro}
SVM maximalizuje margin: $\min\frac12\lVert w\rVert^2$ za $y_i(w^{\!\top}x_i+b)\ge1$; hranici určují podpůrné vektory. Měkký margin: $+C\sum\xi_i$ ($C$ váží chyby vs šířku marginu). Jádro (RBF) = nelineární hranice bez explicitního prostoru rysu.
\end{jadro}
